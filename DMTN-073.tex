...
\newcommand{\joininc}[1]{\include{generated/#1_join}}
...
The complete set of conceptual DataUnit relationships is shown in Figure~\ref{rel:DataUnitJoins}.
