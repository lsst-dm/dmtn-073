...
\newcommand{\unitinc}[1]{\include{generated/#1_unit}}
...
All of the concrete DataUnits described in this section play the role in how they relate to Datasets, but they can have very different representations in the SQL schema.

All DataUnits have one or more \textbf{Value Fields}, which provide those links to the Dataset table.
